...
function IconItemsTwo() {
    ...
    return (
        <div className="container">
            ...
            <img src="/img/image23-3.svg" className="img1" alt="Error" onMouseMove={e => e.currentTarget.src = "/img/image24.svg"} onMouseLeave={e => e.currentTarget.src = "/img/image23-3.svg"}></img>
            ...
            <input type="checkbox" class="checkboxOne" id="checkbox4" checked={checked} onChange={() => setChecked(!checked)} />
            <label for="checkbox4">100 мл</label>
        </div>
        <div class="element-wrapperOne">
         <input type="checkbox" class="checkboxOne" id="checkbox5"  />
            <label for="checkbox5">200мл</label>
            </div>
            <div class="element-wrapperOne">
            <input type="checkbox" class="checkboxOne" id="checkbox6" />
            <label for="checkbox6">300 мл</label>
        </div>
            </div>
